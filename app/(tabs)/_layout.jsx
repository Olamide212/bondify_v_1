...
export default function TabsLayout() {
  ...
  useEffect(() => {
    ...
    // Store handler references so off() removes the right listeners
    ...
    <>
      ...
      >
        <NativeTabs.Trigger name="home">
          ...
          <Label selectedStyle={{ color: selectedContentColor, fontWeight: "700" }}>
            Home
          </Label>
        </NativeTabs.Trigger>
        ...
        <NativeTabs.Trigger name="matches">
          ...
          {newLikes > 0 && (
            <Badge>{newLikes > 99 ? "99+" : newLikes}</Badge>
          )}
        </NativeTabs.Trigger>
