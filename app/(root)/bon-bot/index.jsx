...
const styles = StyleSheet.create({
  ...
  headerInfo:   { flex: 1 },
  headerTitle:  { fontSize: 16, color: '#E5E5E5', fontFamily: "OutfitBold" },
  onlineRow:    { flexDirection: "row", alignItems: "center", gap: 5, marginTop: 2 },
  onlineDot:    { width: 7, height: 7, borderRadius: 4, backgroundColor: "#22c55e" },
  onlineLabel:  { fontSize: 10, fontWeight: "800", color: PRIMARY, letterSpacing: 0.7, fontFamily: "Outfit" },
  ...
  aiBubbleText:    { fontSize: 15, color: '#E5E5E5', lineHeight: 22, fontFamily: "Outfit" },
  ...
  suggestionLabel:  { fontSize: 11, fontWeight: "800", color: PRIMARY, letterSpacing: 0.8, fontFamily: "Outfit" },
  suggestionQuote:  { fontSize: 15, color: '#E5E5E5', lineHeight: 22, fontFamily: "Outfit" },
  ...
  copyBtnText:      { fontSize: 14, color: PRIMARY, fontWeight: "600", fontFamily: "Outfit" },

  tipCard:    { backgroundColor: PRIMARY_LIGHT, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, gap: 4, maxWidth: "96%" },
  tipLabel:   { fontSize: 13, fontWeight: "700", color: PRIMARY, fontFamily: "Outfit" },
  tipContent: { fontSize: 14, color: '#D1D5DB', lineHeight: 20, fontFamily: "Outfit" },
  ...
  userBubbleText:        { fontSize: 15, color: "#fff", lineHeight: 22, fontFamily: "Outfit" },
  ...
  timestamp:     { fontSize: 11, color: "#aaa", marginTop: 4, alignSelf: "flex-end", fontFamily: "Outfit" },
  timestampUser: { fontSize: 11, color: "rgba(255,255,255,0.6)", marginTop: 4, alignSelf: "flex-end", fontFamily: "Outfit" },

  errorBubble: { backgroundColor: '#2A1A1A', borderWidth: 1, borderColor: "#fecaca", borderRadius: 14, padding: 12, maxWidth: "96%", gap: 6 },
  errorText:   { fontSize: 14, color: "#ef4444", fontFamily: "Outfit" },
  retryBtn:    { flexDirection: "row", alignItems: "center", gap: 5 },
  retryText:   { fontSize: 12, color: PRIMARY, fontFamily: "Outfit" },
  ...
  chipLabel:   { fontSize: 12, color: '#D1D5DB', fontFamily: "Outfit" },
  ...
  textInput:      { flex: 1, fontSize: 15, color: '#fff', maxHeight: 100, fontFamily: "Outfit", paddingTop: 0, paddingBottom: 0 },
