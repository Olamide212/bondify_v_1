        ...
        <View style={{flex: 1}} className="px-6 ">
          ...
          {step === "phone" ? (
            ...
            <>
              ...
              <Text className="text-base font-PlusJakartaSans text-gwhite mb-8 leading-6 text-white">
                We sent a verification code to your email to confirm the phone number change to{" "}
                <Text className="font-PlusJakartaSansMedium text-primary">
                  {countryCode}{phoneNumber}
                </Text>
              </Text>

              <TextInput
                className="border border-white rounded-xl px-4 py-4 text-3xl font-PlusJakartaSansBold text-white text-center tracking-widest mb-6"
                placeholder="- - - - - -"
